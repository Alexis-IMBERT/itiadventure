...
public class Piece extends ElementStructurel {
    // Attributs
    /**
     * Attributs recencent les porte dans la piece
     */
    private Map<String, Porte> portes = new HashMap<String, Porte>();
    /**
     * Attribut de la classe : liste d'objet présent dans la pièce initialisé à
     * vide.
     */
    private Map<String, Objet> objets = new HashMap<String, Objet>();
    /**
     * Attribut de la classe : liste de vivant présent dans la pièce initialisé à
     * vide.
     */
    ...
    /**
     * Permet de retirer un objet de la pièce grace à la chaine de caractère le
     * désignant.
     * 
    ...
    /**
     * Recherche la présence d'un vivant dans la pièce grace à la chaine de
    ...
    public String toString() {
        String string = "Piece de nom %s, dans le monde %s, avec les portes %s, les objets %s et les vivants %s";
        return String.format(string, this.getNom(), this.getMonde().toString(), this.getPortes().toString(),
                this.getObjets().toString(), this.getVivants().toString());
    }
}