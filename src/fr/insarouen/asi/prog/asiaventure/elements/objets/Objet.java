...
/**
 * Classe abstraite désignant un objet héritant de Entité
 *
...
public abstract class Objet extends Entite {
	 ...
	 *
	 * @return boolean : True si l'objet est déplacable ,False sinon, par défaut (si
	 *         pas de redéfinition) : false
	 */
